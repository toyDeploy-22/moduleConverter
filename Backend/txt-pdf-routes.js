...
// Local:
import { txtUpload, txtCheck, txt2Pdf } from "./Functions/txt-2-pdf.js";
// 3rd Party:
import cors from "cors";
import Express from "express";
// destruct/constants/variables
const txt_pdf_conv = Express.Router();
let downloadFile = {};

txt_pdf_conv.post("/txt-2-pdf", cors(), txtUpload, async(req, res, next )=>{ 
  ...
  try {
        ...
        switch (checker.code.toString()[0]) {
          ...
          break; 
          case "2":   
          const newPdfFile = await txt2Pdf();
// can use "res.download(newFile.file.toString());" but nothing can be done after it, contrary to res.writeHead.
        ...
        **/
          ...
          txt_pdf_conv.get("/txt-2-pdf/getFile", cors(), async(req, res, next )=>{ 
            try {
